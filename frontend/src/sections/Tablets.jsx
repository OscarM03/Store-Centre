...
const Tablets = () => {
    ...
    const {data: tabletsList = [], isLoading, error} = useQuery({
        ...
        <section className="container">
            <div className="mx-20 max-md:mx-10 max-sm:mx-3 mt-10 ">
                <div className="flex justify-between items-center">
                    ...
                    <a href={`/all?q=${encodeURIComponent('tablets')}`}><h1 className="text-sm text-gray-400 font-bold border-r-2 border-l-2 px-2 border-xiaomi-color">See All</h1></a>
                </div>
