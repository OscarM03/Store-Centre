...
const cartItemCount = error ? 0 : cartItems.length;
      ...
      <nav className=" flex justify-between items-center py-1 mx-20 max-md:mx-4">
          <a href="/" className="header__logo">
            <div className="flex items-center">
              <img src={XiaomiLogo} alt="Logo" width={50} className="max-md:w-[40px]" />
        ...
        <div className="flex justify-center items-center gap-5">
          ...
          <div className="relative">
            ...
            <p className="absolute -top-3 -right-1 bg-dark-bg text-xiaomi-color font-bold"> {isLoading ? '...' : cartItemCount}</p>
          </div>
