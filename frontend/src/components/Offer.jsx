            ...
            offerList.map((product, index) => (
              ...
              >
                <div className="text-center font-bold p-2">
                  <h1 className="text-xiaomi-color text-3xl max-md:text-4xl font-semibold max-sm:mt-6">
                    Exclusive Deal:
                  </h1>
                  ...
                  <h1 className="text-xiaomi-color font-semibold pt-1 hover:text-white">
                    ...
                    <span className="line-through text-gray-400 text-xs font-bold">
                      Ksh {parseFloat(product.original_price).toLocaleString()}
                    </span>
                  </h1>
                  <p className="text-gray-400 text-sm mt-1 font-bold">
                    <span className="text-xiaomi-color">Offer ends:</span>{" "}
                    {timeLeftList[index]}
                  </p>
